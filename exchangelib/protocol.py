...
from .credentials import Credentials, OAuth2Credentials
...
from .transport import get_auth_instance, get_service_authtype, AUTH_TYPE_MAP, DEFAULT_HEADERS, NTLM, GSSAPI, SSPI, \
    OAUTH2
